---
title: "Specboot Project Structure After Installation"
sidebarTitle: "Project Structure"
description: "Understand every directory and file Specboot installs: docs/ standards, ai-specs/ agents and skills, copilot config symlinks, and the Cursor rules integration."
---
...
Add your own agent definitions here as your team develops specialized roles. Any new file you add will be picked up by the symlink structure in `.claude/agents/` and `.cursor/agents/` after running `sync-agent-symlinks`.
...
- **`sync-agent-symlinks/`** — Synchronize `.claude/skills/` and `.cursor/skills/` with `ai-specs/skills/`
