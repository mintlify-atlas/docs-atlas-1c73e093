...
description: "Spec-driven development uses specifications as the source of truth for AI agents. Learn how Specboot enforces this pattern and why it produces better AI-assisted code."
---
...
The following principles are defined in `docs/base-standards.md` Section 1 and Section 2, and applied by every agent that loads the file:
...
| **English only** | All code, comments, docs, commits, and data schemas in English |
