...
description: "Enhance Specboot's OpenSpec workflow with optional Jira MCP for ticket enrichment and Playwright MCP for automated E2E testing. Both are optional and replaceable."
---
