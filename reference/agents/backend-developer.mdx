...
description: "Plans TypeScript DDD backend features with Express and Prisma ORM across Domain, Application, Infrastructure, and Presentation layers. Plan-only agent."
---
