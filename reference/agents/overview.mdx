...
description: "Specboot ships three pre-built AI agent role definitions — backend developer, frontend developer, and product analyst — each with expert system prompts and tool configurations."
---
...
<CardGroup cols={2}>
  ...
  >
    React component architecture expert. Implements service layers, hooks, React Router, and React Bootstrap patterns. Saves plans to `.claude/doc/{feature}/frontend.md`.
  </Card>
  <Card
