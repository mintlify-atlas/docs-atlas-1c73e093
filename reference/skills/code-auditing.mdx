---
title: "code-auditing Skill: Systematic 6-Phase Code Quality Audit"
sidebarTitle: "code-auditing"
description: "The code-auditing skill runs a systematic 6-phase audit covering security, performance, type safety, dead code, and library best practices, ending with a prioritized action plan."
---

The `code-auditing` skill provides a structured, repeatable approach to code quality reviews. Rather than ad-hoc inspection, it guides the agent through six defined phases — from baseline setup to a comprehensive prioritised report — ensuring nothing is missed and findings are actionable.
...
<Steps>
  <Step title="Phase 0: Pre-Analysis Setup">
    ...
    - Use Context7 MCP to pre-load documentation for identified core libraries
  ...
  <Step title="Phase 3: Best Practices Verification">
    ...
    1. Retrieve the current official documentation (use Context7)
  ...
  <Step title="Phase 5: Library Recommendations">
    ...
    1. Check if current libraries already provide the functionality (use Context7)
  ...
  <Step title="Phase 6: Comprehensive Report">
    ...
    - **Prioritised action plan**: effort estimates (S/M/L/XL), dependencies between tasks, suggested sprint allocation
