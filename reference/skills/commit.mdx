...
sidebarTitle: "commit"
description: "Stage relevant changes, write a descriptive commit message, push, and open a GitHub PR. Supports full-tree, ticket-scoped, and description-only modes."
---
