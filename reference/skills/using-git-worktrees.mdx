---
title: "using-git-worktrees Skill: Isolated Workspaces for Features"
sidebarTitle: "Git Worktrees"
description: "Set up an isolated git worktree before feature work. Detects existing isolation, prefers native tools, and safely removes the worktree on completion."
---
